...
import { formatCompactNumber, formatNumber, formatPercentage } from '../../../../common/utils/number-format.util';
  ...
  private buildStats(summary: LeadershipSummary): void {
    ...
    this.stats = [
      ...
      },
      {
        ...
        icon: 'trending_up',
        iconColor: a.notifications_billed_ratio && a.notifications_billed_ratio >= 0.9 
          ? 'text-green-600' 
          : 'text-orange-600'
      }
    ];
